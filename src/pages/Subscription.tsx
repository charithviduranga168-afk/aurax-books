...
export default function Subscription() {
  ...
  function payViaPayHere() {
    ...
    const fields: Record<string, string> = {
      ...
      notify_url: '',
      order_id: orderId,
      items: `NeoGrid Subscription — ${currentPeriod} (${totalUsers} user${totalUsers > 1 ? 's' : ''})`,
      currency,
      amount,
    ...
    <div>
      ...
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Manage your NeoGrid plan and team members</div>
        </div>
      </div>
          ...
          <div className="card" style={{ marginBottom: '20px' }}>
            ...
            {members.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '32px 0', color: 'var(--text3)', fontSize: '13px' }}>
                No team members yet. Add members to collaborate on NeoGrid.
              </div>
            ) : (
              members.map((m) => (
